...
Public Class LibraryUserAccounts
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Session.Item("IsThisU") <> Nothing Then
                ...
                CreateSUserButton = Master.FindControl("Accordion1").FindControl("LibAdminPane").FindControl("Lib_User_Bttn")
    ...
    Protected Sub Save_Click(ByVal sender As Object, ByVal e As EventArgs) Handles bttn_Save.Click
        If IsPostBack = True Then
            ...
            Try
                ...
                '****************************************************************************************88
                'Default Lang
                Dim myLang As String = Nothing
                myLang = Trim(Me.DropDownList4.SelectedValue)
                If Not String.IsNullOrEmpty(myLang) Then
                    myLang = RemoveQuotes(myLang)
                    If myLang.Length > 4 Then
                        ClientScript.RegisterStartupScript(Me.GetType(), "myalert", "alert('  Input is not Valid... ');", True)
                        Me.DropDownList4.Focus()
                        Exit Sub
                    End If
                    myLang = " " & myLang & " "
                    If InStr(1, myLang, "CREATE", 1) > 0 Or InStr(1, myLang, "DELETE", 1) > 0 Or InStr(1, myLang, "DROP", 1) > 0 Or InStr(1, myLang, "INSERT", 1) > 1 Or InStr(1, myLang, "TRACK", 1) > 1 Or InStr(1, myLang, "TRACE", 1) > 1 Then
                        ClientScript.RegisterStartupScript(Me.GetType(), "myalert", "alert('  Input is not Valid... ');", True)
                        Me.DropDownList4.Focus()
                        Exit Sub
                    End If
                    myLang = TrimAll(myLang)
                    'check unwanted characters
                    c = 0
                    counter8 = 0
                    For iloop = 1 To Len(myLang)
                        strcurrentchar = Mid(myLang, iloop, 1)
                        If c = 0 Then
                            If Not InStr("'~!@#$^&*|[]{}?<>%""", strcurrentchar) <= 0 Then
                                c = c + 1
                                counter8 = 1
                ...
                dtrow("USER_TYPE") = "USER"
                dtrow("STATUS") = "CU"

                dtrow("DATE_ADDED") = Now.ToShortDateString
                dtrow("USER_IP") = Request.UserHostAddress.Trim
                ...
                Else
                    dtrow("USER_SER") = "N"
                End If
                If CheckBoxList1.Items(4).Selected = True Then
                    dtrow("USER_ART") = "Y"
                Else
                    dtrow("USER_ART") = "N"
                End If
                ...
                Else
                    dtrow("USER_BUDGET") = "N"
                End If
                If CheckBoxList1.Items(6).Selected = True Then
                    dtrow("USER_SEARCH") = "Y"
                Else
                    dtrow("USER_SEARCH") = "N"
                End If
                If CheckBoxList1.Items(7).Selected = True Then
                    dtrow("USER_MASTER") = "Y"
                Else
                    dtrow("USER_MASTER") = "N"
                End If
                ...
                Else
                    dtrow("USER_ISSUE") = "N"
                End If
                If CheckBoxList2.Items(1).Selected = True Then
                    dtrow("USER_RETURN") = "Y"
                Else
                    dtrow("USER_RETURN") = "N"
                End If
                If CheckBoxList2.Items(2).Selected = True Then
                    dtrow("USER_RESERVE") = "Y"
                Else
                    dtrow("USER_RESERVE") = "N"
                End If
                If CheckBoxList2.Items(3).Selected = True Then
                    dtrow("USER_PRINT") = "Y"
                Else
                    dtrow("USER_PRINT") = "N"
                End If
                If CheckBoxList2.Items(4).Selected = True Then
                    dtrow("USER_ADDNEW") = "Y"
                Else
                    dtrow("USER_ADDNEW") = "N"
                End If
                If CheckBoxList2.Items(5).Selected = True Then
                    dtrow("USER_EDIT") = "Y"
                Else
                    dtrow("USER_EDIT") = "N"
                End If
                If CheckBoxList2.Items(6).Selected = True Then
                    dtrow("USER_DELETE") = "Y"
                Else
                    dtrow("USER_DELETE") = "N"
                End If
    ...
    Protected Sub Search_Bttn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Search_Bttn.Click
        ...
        Try
            ...
            If DropDownList1.Text <> "" Then
                UserStatus = TrimAll(DropDownList1.SelectedValue)
                UserStatus = RemoveQuotes(UserStatus)
                If UserStatus.Length > 20 Then
                    ClientScript.RegisterStartupScript(Me.GetType(), "myalert", "alert('  Input is not Valid... ');", True)
                    Me.DropDownList1.Focus()
                    Exit Sub
                End If
                UserStatus = " " & UserStatus & " "
                If InStr(1, UserStatus, "CREATE", 1) > 0 Or InStr(1, UserStatus, "DELETE", 1) > 0 Or InStr(1, UserStatus, "DROP", 1) > 0 Or InStr(1, UserStatus, "INSERT", 1) > 1 Or InStr(1, UserStatus, "TRACK", 1) > 1 Or InStr(1, UserStatus, "TRACE", 1) > 1 Then
                    ClientScript.RegisterStartupScript(Me.GetType(), "myalert", "alert('  Input is not Valid... ');", True)
                    Me.DropDownList1.Focus()
                    Exit Sub
                End If
                UserStatus = TrimAll(UserStatus)
                'check unwanted characters
                c = 0
                counter4 = 0
                For iloop = 1 To Len(UserStatus)
                    strcurrentchar = Mid(UserStatus, iloop, 1)
                    If c = 0 Then
                        If Not InStr("';<>=()%""", strcurrentchar) <= 0 Then
                            c = c + 1
                            counter4 = 1
            ...
            SQL = "SELECT * FROM USERS WHERE (USER_TYPE ='USER') AND (LIB_CODE='" & Trim(LibCode) & "') AND ( STATUS = '" & Trim(UserStatus) & "') "
            ...
            If dtUsers.Rows.Count = 0 Then
                ...
                ' Grid_User.Items.Clear()
                Label5.Text = "Total Record(s): " & Grid_User.Rows.Count
            Else
                RecordCount = dtUsers.Rows.Count
                ' Grid_User.RecordCount = RecordCount
                Grid_User.DataSource = dtUsers
                Grid_User.DataBind()
                Label5.Text = "Total Record(s): " & Grid_User.Rows.Count
            End If
    ...
    Private Sub Grid_User_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles Grid_User.RowCommand
        ...
        Try
            If e.CommandName = "Select" Then
                ...
                USER_CODE = Grid_User.DataKeys(myRowID).Value
                If USER_CODE <> "" Then
                    Dim iloop As Integer
                    Dim strcurrentchar As Object
                    Dim c As Integer
                    ...
                    Me.txt_UserCode.Text = USER_CODE
                    ...
                    If drUSERS.HasRows = True Then
                        ...
                        Else
                            txt_Remarks.Text = ""
                        End If
                        If drUSERS.Item("STATUS").ToString <> "" Then
                            If drUSERS.Item("STATUS").ToString = "CU" Then
                                RadioButton1.Checked = True
                        ...
                        Else
                            ...
                            RadioButton2.Checked = True
                        End If
                        If drUSERS.Item("LANG_CODE").ToString <> "" Then
                            DropDownList4.SelectedValue = drUSERS.Item("LANG_CODE").ToString
                        Else
                            DropDownList4.SelectedValue = "ENG"
                        End If

                        If drUSERS.Item("USER_ACQ").ToString <> "" Then
                        ...
                        If drUSERS.Item("USER_CAT").ToString <> "" Then
                        ...
                        If drUSERS.Item("USER_CIR").ToString <> "" Then
                        ...
                        Else
                            CheckBoxList1.Items(2).Selected = False
                        End If
                        If drUSERS.Item("USER_SER").ToString <> "" Then
                        ...
                        Else
                            CheckBoxList1.Items(3).Selected = False
                        End If
                        If drUSERS.Item("USER_ART").ToString <> "" Then
                        ...
                        Else
                            CheckBoxList1.Items(4).Selected = False
                        End If
                        If drUSERS.Item("USER_BUDGET").ToString <> "" Then
                        ...
                        If drUSERS.Item("USER_SEARCH").ToString <> "" Then
                        ...
                        If drUSERS.Item("USER_MASTER").ToString <> "" Then
                            If drUSERS.Item("USER_MASTER").ToString = "Y" Then
                        ...
                        If drUSERS.Item("USER_ISSUE").ToString <> "" Then
                            If drUSERS.Item("USER_ISSUE").ToString = "Y" Then
                                CheckBoxList2.Items(0).Selected = True
                            Else
                        ...
                        If drUSERS.Item("USER_RETURN").ToString <> "" Then
                            If drUSERS.Item("USER_RETURN").ToString = "Y" Then
                                CheckBoxList2.Items(1).Selected = True
                            Else
                        ...
                        Else
                            CheckBoxList2.Items(1).Selected = False
                        End If
                        If drUSERS.Item("USER_RESERVE").ToString <> "" Then
                            If drUSERS.Item("USER_RESERVE").ToString = "Y" Then
                                CheckBoxList2.Items(2).Selected = True
                            Else
                        ...
                        Else
                            CheckBoxList2.Items(2).Selected = False
                        End If
                        If drUSERS.Item("USER_PRINT").ToString <> "" Then
                            If drUSERS.Item("USER_PRINT").ToString = "Y" Then
                                CheckBoxList2.Items(3).Selected = True
                            Else
                        ...
                        Else
                            CheckBoxList2.Items(3).Selected = False
                        End If
                        If drUSERS.Item("USER_ADDNEW").ToString <> "" Then
                            If drUSERS.Item("USER_ADDNEW").ToString = "Y" Then
                                CheckBoxList2.Items(4).Selected = True
                            Else
                        ...
                        Else
                            CheckBoxList2.Items(4).Selected = False
                        End If
                        If drUSERS.Item("USER_EDIT").ToString <> "" Then
                            If drUSERS.Item("USER_EDIT").ToString = "Y" Then
                                CheckBoxList2.Items(5).Selected = True
                            Else
                        ...
                        Else
                            CheckBoxList2.Items(5).Selected = False
                        End If
                        If drUSERS.Item("USER_DELETE").ToString <> "" Then
                            If drUSERS.Item("USER_DELETE").ToString = "Y" Then
                                CheckBoxList2.Items(6).Selected = True
                            Else
        ...
        Try
            If IsPostBack = True Then
                ...
                If ds.Tables("USERS").Rows.Count <> 0 Then
                    ...
                    End If
                    If Not String.IsNullOrEmpty(myLang) Then
                        ds.Tables("USERS").Rows(0)("LANG_CODE") = myLang.ToString.Trim
                    Else
                        ds.Tables("USERS").Rows(0)("LANG_CODE") = System.DBNull.Value
                    End If


                    If CheckBoxList1.Items(0).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_ACQ") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_ACQ") = "N"
                    End If
                    If CheckBoxList1.Items(1).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_CAT") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_CAT") = "N"
                    End If
                    If CheckBoxList1.Items(2).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_CIR") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_CIR") = "N"
                    End If
                    If CheckBoxList1.Items(3).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_SER") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_SER") = "N"
                    End If
                    If CheckBoxList1.Items(4).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_ART") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_ART") = "N"
                    End If
                    If CheckBoxList1.Items(5).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_BUDGET") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_BUDGET") = "N"
                    End If
                    If CheckBoxList1.Items(6).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_SEARCH") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_SEARCH") = "N"
                    End If

                    If CheckBoxList1.Items(7).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_MASTER") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_MASTER") = "N"
                    End If

                    If CheckBoxList2.Items(0).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_ISSUE") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_ISSUE") = "N"
                    End If
                    If CheckBoxList2.Items(1).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_RETURN") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_RETURN") = "N"
                    End If
                    If CheckBoxList2.Items(2).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_RESERVE") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_RESERVE") = "N"
                    End If
                    If CheckBoxList2.Items(3).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_PRINT") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_PRINT") = "N"
                    End If
                    If CheckBoxList2.Items(4).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_ADDNEW") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_ADDNEW") = "N"
                    End If
                    If CheckBoxList2.Items(5).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_EDIT") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_EDIT") = "N"
                    End If
                    If CheckBoxList2.Items(6).Selected = True Then
                        ds.Tables("USERS").Rows(0)("USER_DELETE") = "Y"
                    Else
                        ds.Tables("USERS").Rows(0)("USER_DELETE") = "N"
                    End If

                    If RadioButton1.Checked = True Then
                        ds.Tables("USERS").Rows(0)("STATUS") = "CU"
                    Else
                        ds.Tables("USERS").Rows(0)("STATUS") = "CL"
                    End If
    ...
    Public Sub PopulateLanguages()
        ...
        Try
            Command = New SqlCommand("SELECT LANG_ID, LANG_CODE, LANG_NAME FROM LANGUAGES ORDER BY LANG_NAME ", SqlConn)
            SqlConn.Open()
            ...
            Else
                ...
                Me.DropDownList4.DataTextField = "LANG_NAME"
                Me.DropDownList4.DataValueField = "LANG_CODE"
                Me.DropDownList4.DataBind()
            End If
            dt.Dispose()
        Catch s As Exception
