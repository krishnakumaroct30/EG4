<%@ Page  Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LibraryUserAccounts.aspx.vb" Inherits="EG4.LibraryUserAccounts" %>
 ...
 <script type="text/javascript">
    ...
    <script language ="javascript" type ="text/javascript" >
        function Select(Select) {
            ...
            var grdv = document.getElementById('<%= Grid_User.ClientID %>');
            var chbk = "cbd";
            ...
            <tr>                
                ...
                <ajaxToolkit:Accordion ID="Accordion2" runat="server" CssClass="accordion"  
                    ...
                    <asp:DropDownList ID="DropDownList2" runat="server" ForeColor="#0066FF">
                        ...
                        <asp:ListItem Value="USER_DESIG">Designation</asp:ListItem>
                    ...
                    <asp:GridView ID="Grid_User" runat="server" AllowPaging="True" DataKeyNames="USER_CODE"  
         ...
         <table id="Table1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            ...
            <tr  runat="server">
             ...
             <tr  runat="server">
                 <td class="style51">Default Language</td>
                 <td class="style52">
              ...
              <tr  runat="server">
                 <td class="style51">Module Permission</td>
                 <td class="style52">
                     <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatColumns="4">
                         <asp:ListItem Value="ACQ" Selected="True">Acquisition</asp:ListItem>
                         <asp:ListItem Value="CAT" Selected="True">Cataloging</asp:ListItem>
                         <asp:ListItem Value="CIR" Selected="True">Circulation</asp:ListItem>
                         <asp:ListItem Value="SER" Selected="True">Serials</asp:ListItem>
                         <asp:ListItem Value="ART" Selected="True">Articles</asp:ListItem>
                         <asp:ListItem Value="BUD" Selected="True">Budgets</asp:ListItem>
                         <asp:ListItem Value="SEA" Selected="True">Search</asp:ListItem>
                         <asp:ListItem Selected="True">Master</asp:ListItem>
                     </asp:CheckBoxList>
                 </td>
             </tr>
              <tr  runat="server">
                 <td class="style51">Action Permission</td>
                 <td class="style52">
                     <asp:CheckBoxList ID="CheckBoxList2" runat="server" RepeatColumns="4">
                         <asp:ListItem Value="ISSUE" Selected="True">Issue</asp:ListItem>
                         <asp:ListItem Value="RETURN" Selected="True">Return</asp:ListItem>
                         <asp:ListItem Value="RESERVE" Selected="True">Reserve</asp:ListItem>
                         <asp:ListItem Value="PRINT" Selected="True">Print</asp:ListItem>
                         <asp:ListItem Value="ADDNEW" Selected="True">Add New</asp:ListItem>
