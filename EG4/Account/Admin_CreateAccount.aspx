...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
            ...
            function test1() {
                ...
                if (document.getElementById('<%=txt_UserPhone.ClientID%>').value != "") {
                    re = /^\d{5,12}$/;                   
                    if (!re.test(document.getElementById('<%=txt_UserPhone.ClientID%>').value)) {
                        alert("Error: Not a proper Phone Number!");
                        document.getElementById("MainContent_txt_UserPhone").focus();
                        return (false);
                    }
                }
                if (document.getElementById('<%=txt_UserMobile.ClientID%>').value != "") {
                    re = /^\d{10,15}$/;
                    if (!re.test(document.getElementById('<%=txt_UserMobile.ClientID%>').value)) {
                        alert("Error: Not a proper Mobile Number!");
                        document.getElementById("MainContent_txt_UserMobile").focus();
                        return (false);
                    }
                }                       
     ...
     <script type="text/javascript">
        ...
        <table id="ADMT1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            ...
            <tr>
                ...
                &nbsp;<span class="style51">6-10 Chars Length, Alpha-Numeric with Spl Char, atleast one Caps Letter</span>

                <div id="pwdDescription" class="explain" style="color: red"></div>

                <input id="HashPass2" type="hidden" name="HashPass2" runat ="server" class="style52" />
