    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                Command = New SqlCommand("SELECT LIB_LOGO FROM LIBRARIES WHERE(LIB_CODE='" & Trim(myLibCode) & "')", sqlconn)
                ...
                Else
                    drUser.Read()
                    Response.BinaryWrite(drUser("LIB_LOGO"))
                End If
            End If
