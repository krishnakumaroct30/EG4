<%@ Page  Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="CopyStatus.aspx.vb" Inherits="EG4.CopyStatus" %>
 ...
 <script type="text/javascript">
     ...
     <script type ="text/javascript">
        ...
        <table id="ADMT1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            <tr>
                <td  bgcolor="#003366" class="style43" rowspan="1" style="color: #FFFFFF"><strong>Change Copy Status</strong></td>
            </tr>
            <tr>  
                ...
                <td  align="center">     
                   ...
                   <div class="style56">
                       <asp:Label ID="Label515" runat="server" Font-Bold="True" Font-Size="Medium" 
                           ForeColor="White" Text="STEP 2: Select New Status: "></asp:Label>
                ...
                <td class="style56" colspan="9" bgcolor="#336699">
                   ...
                   <asp:Label ID="Label516" runat="server" Font-Size="Small" ForeColor="White" 
                    ...
                    <asp:DropDownList ID="DDL_GroupBy" runat="server" Font-Bold="True" 
                        ...
                        <asp:ListItem Value="STA_NAME">Status</asp:ListItem>
                    </asp:DropDownList>
         ...
         <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
             ...
             <tr>
                <td class="style56" colspan="3">
                   <asp:Label ID="Label13" runat="server" Font-Size="Medium" ForeColor="White" 
                        Font-Bold="True" Text="Add/Update REMARKS - If Any"></asp:Label>
                        <br />
                </td>
            </tr>
             ...
             <tr>
                <td class="style53"> 
                    <asp:Label ID="Label514" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="Accession No"></asp:Label>
                    </td>
                              
                <td class="style54">                    
                    <asp:Label ID="Label_AccessionNo" runat="server"></asp:Label>                                      
                </td>
            ...
            <tr>
                <td class="style53">
                    <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Size="Small" Text="Accession Date"></asp:Label></td>
                <td class="style54" colspan="2">
                    <asp:Label ID="Label_AccessionDate" runat="server"></asp:Label>
                </td>
            </tr>
            ...
            <tr>
                <td class="style53">
                    <asp:Label ID="Label61" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="Volume No"></asp:Label>
                    </td>
                <td class="style54" colspan="2">
                    <asp:Label ID="Label_VolNo" runat="server"></asp:Label>
                    </td>
            </tr>
            <tr>
                <td class="style53">
