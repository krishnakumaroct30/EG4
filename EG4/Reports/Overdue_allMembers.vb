...
Public Class Overdue_allMembers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EG4.Overdue_allMembers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOverdue_allMembers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Overdue_allMembers = New Overdue_allMembers()
        rpt.Site = Me.Site
        Return rpt
    End Function
