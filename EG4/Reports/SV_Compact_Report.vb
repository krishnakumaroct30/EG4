...
Public Class SV_Compact_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EG4.SV_Compact_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSV_Compact_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SV_Compact_Report = New SV_Compact_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
