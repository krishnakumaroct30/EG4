...
Public Class Payment_Summary_Report
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Payment_Summary_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EG4.Payment_Summary_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayment_Summary_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Payment_Summary_Report = New Payment_Summary_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
