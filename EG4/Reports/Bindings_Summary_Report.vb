...
Public Class Bindings_Summary_Report
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Bindings_Summary_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EG4.Bindings_Summary_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBindings_Summary_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bindings_Summary_Report = New Bindings_Summary_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
