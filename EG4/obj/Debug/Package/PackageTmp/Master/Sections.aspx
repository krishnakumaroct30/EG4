<%@ Page  Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Sections.aspx.vb" Inherits="EG4.Sections" SmartNavigation ="true" MaintainScrollPositionOnPostback="true"  %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <script type="text/javascript">
       ...
       function onLoad() {
           ...
           ids = ["MainContent_txt_Sec_Name", "MainContent_txt_Sec_Remarks"];
    ...
    <script language="javascript" type="text/javascript">
           ...
           function valid1() {
               var code = "";
               code = document.getElementById('<%=txt_Sec_Code.ClientID%>').value;
              
               if (code == "") {
                   alert("Please enter proper and distinct  \"Section code\" field.");
                   document.getElementById("MainContent_txt_Sec_Code").focus();
                   return (false);
               }
               if (document.getElementById('<%=txt_Sec_Code.ClientID%>').value.length < 1) {
                   alert("Length of \"Section Code\" should be Min 1 characters.");
                   document.getElementById("MainContent_txt_Sec_Code").focus();
                   return (false);
               }
               if (document.getElementById('<%=txt_Sec_Code.ClientID%>').value.length > 5) {
                   alert("Length of \"Section Code\" should be Max 5 characters.");
                   document.getElementById("MainContent_txt_Sec_Code").focus();
                   return (false);
               }

               if (document.getElementById('<%=txt_Sec_Name.ClientID%>').value == "") {
                    alert("Please enter Section Name...");
                    document.getElementById("MainContent_txt_Sec_Name").focus();
                    return (false);
                }              
    ...
    <script language ="javascript" type ="text/javascript" >
        function Select(Select) {
            ...
            var grdv = document.getElementById('<%= Grid_Section.ClientID %>');
            var chbk = "cbd";
         ...
         <table id="ADMT1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            ...
            <tr>                
                <td  align="center" colspan="2">     
                   ...
                   <asp:GridView ID="Grid_Section" runat="server" AllowPaging="True" DataKeyNames="SEC_ID"  
                    ...
                    <asp:BoundField   DataField="SEC_CODE" HeaderText="Code" 
                                SortExpression="SEC_CODE" >                                               
                            <HeaderStyle Font-Bold="True" Font-Names="Tahoma" Font-Size="Small" />
                        <ItemStyle forecolor="#0066FF" horizontalalign="Left" width="100px" 
                                Font-Names="Arial"/>                        
                    </asp:BoundField>
                    <asp:BoundField   DataField="SEC_NAME" HeaderText="Section Name" ReadOnly="True"  
                                SortExpression="SEC_NAME">                                               
                            <HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" />
                        <ItemStyle forecolor="#0066FF" horizontalalign="Left" Font-Names="Arial"  
                                width="350px" />                        
                    </asp:BoundField>
                     <asp:BoundField   DataField="SEC_DESC" HeaderText="Chairman">                                               
                            <HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" />
                        <ItemStyle forecolor="#0066FF" horizontalalign="Left" width="150px" 
                                Font-Names="Arial"/>                        
                    </asp:BoundField>
                     <asp:BoundField   DataField="SEC_ID" HeaderText="ID" visible="true">                                               
                            <HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" />
                   ...
                   <Triggers>
                         ...
                         <asp:AsyncPostBackTrigger ControlID="Grid_Section" EventName="RowCommand" />                                              
                   </Triggers>
                    </asp:UpdatePanel>
         ...
         <table id="Table1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            ...
            <tr>
                <td class="style51"> 
                    Section Code*</td>
                <td class="style54">
                    <asp:TextBox ID="txt_Sec_Code" runat="server" MaxLength="10"  
                        ToolTip="Enter Section Code" Wrap="False" style="text-transform: uppercase"
                        Font-Bold="True" ForeColor="#0066FF" Height="21px" Width="75px"  onkeypress="return suppressNonEng (event)"></asp:TextBox>
                    &nbsp; <asp:Label ID="Label7" runat="server"  Text=""></asp:Label> <asp:Label ID="Label2" runat="server"  Text="Enter Distinct Section Code - ENG &amp; Digits Only; Min 2, Max 5 Char."></asp:Label>
                </td>
            ...
            <tr>
                <td class="style51"> 
                    Section Name *</td>
                <td class="style54">
                    <asp:TextBox ID="txt_Sec_Name" runat="server" MaxLength="250"  
                        ToolTip="Enter Section Name" Wrap="False" 
            ...
            <tr>
                ...
                <td class="style53">
                    <asp:TextBox ID="txt_Sec_Remarks" runat="server" MaxLength="250"  
