<%@ Page  Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Retroconversion.aspx.vb" Inherits="EG4.Retroconversion" %>
    ...
    <script type ="text/javascript">
     ...
     <script type="text/javascript">
        ...
        <table id="ADMT1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            <tr>
                <td  bgcolor="#003366" class="style43" rowspan="1" style="color: #FFFFFF"><strong>Retro-Conversion: Direct Data Entry of Books</strong></td>
            </tr>
            <tr>  
         ...
         <tr>
            ...
            <tr id="TR_SPNo" runat="server">
                ...
                <td class="style54" colspan="13">
                    <asp:TextBox ID="txt_Cat_SPNo" runat="server" AutoCompleteType="DisplayName" 
                        ...
                        ToolTip="Enter Standard Number" Width="50%" Wrap="False"></asp:TextBox>
             ...
             <tr id="TR_ManualNo" runat="server">
                ...
                <td class="style54" colspan="13">
                    <asp:TextBox ID="txt_Cat_ManualNo" runat="server" AutoCompleteType="DisplayName" 
                        Font-Bold="True" ForeColor="#0066FF" MaxLength="100" 
                        ToolTip="Enter Manual No" Width="50%" Wrap="False"></asp:TextBox>
             ...
             <tr id="TR_ReportNo" runat="server">
                ...
                <td class="style54" colspan="13">
                    <asp:TextBox ID="txt_Cat_ReportNo" runat="server" AutoCompleteType="DisplayName" 
                        Font-Bold="True" ForeColor="#0066FF" MaxLength="100" 
                        ToolTip="Enter Report Number" Width="50%" Wrap="False"></asp:TextBox>
             ...
             <tr id="TR_ACT" runat="server">
                ...
                <td class="style54" colspan="7">
                    <asp:TextBox ID="txt_Cat_ActNo" runat="server" AutoCompleteType="DisplayName" 
                        ...
                        ToolTip="Enter Act No" Width="50%" Wrap="False"></asp:TextBox>
             ...
             <tr id="TR_ConfDetails" runat="server">
                ...
                <td class="style54" colspan="4">
                    ...
                    <asp:TextBox ID="txt_Cat_ConfPlace" runat="server" 
                        AutoCompleteType="DisplayName" Font-Bold="True" ForeColor="#0066FF" 
                        Height="20px" MaxLength="100" ToolTip="Enter Conference Place" Width="90%" 
            ...
            <tr id="TR_Author" runat="server">
                ...
                <td class="style54" colspan="4">
                    ...
                    <asp:TextBox ID="txt_Cat_Author1" runat="server" AutoCompleteType="DisplayName" 
                        ...
                        ToolTip="Enter Author1" Width="70%" Wrap="False"></asp:TextBox> 
                    <ajaxToolkit:AutoCompleteExtender 
                ...
                <td class="style54" colspan="5">
                    ...
                    <asp:TextBox ID="txt_Cat_Author2" runat="server" AutoCompleteType="DisplayName" 
                        Font-Bold="True" ForeColor="#0066FF" Height="20px" MaxLength="250" 
                        ToolTip="Enter Author2" Width="70%" Wrap="False"></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender 
                ...
                <td class="style54" colspan="4">
                    ...
                    <asp:TextBox ID="txt_Cat_Author3" runat="server" AutoCompleteType="DisplayName" 
                        Font-Bold="True" ForeColor="#0066FF" Height="20px" MaxLength="250" 
                        ToolTip="Enter Author3" Width="70%" Wrap="False" 
                ...
                <td class="style54" colspan="4">
                 ...
                 <td class="style54" colspan="2">
                     <asp:TextBox ID="txt_Acq_ItemPrice" runat="server" 
                         ...
                         ToolTip="Enter Item Price" Width="90px" Wrap="False"></asp:TextBox>
                 </td>
            </tr>
             <tr id="TR_CONVERSION" runat="server">
                ...
                <td class="style54" colspan="4">
                   <asp:TextBox ID="txt_Acq_ConversionRate" runat="server" 
                         AutoCompleteType="DisplayName" Font-Bold="True" ForeColor="#0066FF" 
                         Height="18px" MaxLength="15" onkeypress="return isCurrencyKey(event)" 
                         ToolTip="Enter Conversion Rate" Width="100px" Wrap="False"></asp:TextBox>
                 </td>               
                 <td class="style53" colspan="3">
                 ...
                 <td class="style54" colspan="2">
                     <asp:TextBox ID="txt_Acq_ItemRupees" runat="server" 
                         AutoCompleteType="DisplayName" Font-Bold="True" ForeColor="#0066FF" 
                         Height="18px" MaxLength="15" onkeypress="return isCurrencyKey(event)" 
                         ToolTip="Enter Item cost in Rupees" Width="100px" Wrap="False"></asp:TextBox>
                 </td>
                 <td class="style53" colspan="2">
                     Other Charges(Rs)</td>
                 <td class="style54" colspan="2">
                     <asp:TextBox ID="txt_Acq_OtherCharges" runat="server" 
                         AutoCompleteType="DisplayName" Font-Bold="True" ForeColor="#0066FF" 
                         Height="18px" MaxLength="15" onkeypress="return isCurrencyKey(event)" 
                         ToolTip="Enter Additional Charges" Width="90px" Wrap="False"></asp:TextBox>
                 </td>
            </tr>
              ...
              <tr style=" color:Red; font-weight:bold">
                ...
                <td class="style54" colspan="13">  
                    <asp:CheckBox ID="CB_RecvAll" runat="server" Font-Bold="True" 
                        ...
                        Text="Accession Multi-Copies with Single Click." 
                        AutoPostBack="True" />
                    <asp:TextBox ID="txt_Hold_Copies" runat="server" Font-Bold="True" 
                        ...
                        Width="50px"  onkeypress="return isNumberKey (event)" ></asp:TextBox>No of Copies To be Accessioned
           ...
           <tr id ="TR_CARTOGRAPHIC_INSPECTION_DATE" runat ="server">
            ...
            <tr>
                <td class="style47" colspan="14">
                    &nbsp; * Mandatory. NOTE: Put semicolon (; ) between two items in the same text box</td>
            </tr>
             <tr>
                <td class="style56" colspan="14">
                    <asp:Button ID="Acq_SaveCopy_Bttn" runat="server" 
                        CssClass="styleBttn" Font-Bold="True" ForeColor="Red" Height="23px" 
                        TabIndex="14" Text="Save Copy" 
                        Width="120px" Visible="False" />
                    <asp:Button ID="Acq_AddCopy_Bttn" runat="server" AccessKey="a" 
                        CssClass="styleBttn" Font-Bold="True" ForeColor="Red" Height="23px" 
                        TabIndex="14" Text="Add Copy" Visible="False" Width="120px" />
                    <asp:Button ID="Acq_Save_Bttn" runat="server" AccessKey="s" 
                        CssClass="styleBttn" Font-Bold="True" ForeColor="Red" Height="23px" 
                        OnClientClick="return valid1();" TabIndex="14" Text="Save" Visible="False" 
                        Width="74px" />
                    <asp:Button ID="Acq_Update_Bttn" runat="server" AccessKey="u" 
                        CssClass="styleBttn" Font-Bold="True" ForeColor="Red" Height="23px" 
                        OnClientClick="return valid2();" TabIndex="14" Text="Update" 
                    ...
                    <asp:Button ID="Acq_Cancel_Bttn" runat="server" AccessKey="c" 
                        ...
                        CssClass="styleBttn" Font-Bold="True" ForeColor="Red" Height="23px" 
                         TabIndex="14" Text="Save As New Title" 
                        Width="135px" Visible="False" OnClientClick="return valid1();" />
                 </td>
            </tr>
         ...
         <tr>
             <td bgcolor="#336699" class="style56" colspan="5">
                 <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="White">Display Holdings/Copies Record(s)</asp:Label>
             </td>
         </tr>
         <tr>
             <td bgcolor="#336699" class="style56" colspan="5">
                 <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="White">HELP: Click the 'Edit' link from Grid below to Edit Copy Record!</asp:Label>
             </td>
         </tr>
          <tr>
             <td bgcolor="#336699" class="style56" colspan="5">
                 ...
                 <asp:GridView ID="Grid2" runat="server" AllowPaging="True" allowsorting="True" 
                   ...
                   <Triggers>
                       ...
                       <asp:PostBackTrigger  ControlID="Acq_Update_Bttn"   />  
                         <asp:AsyncPostBackTrigger ControlID ="Acq_Save_Bttn"  EventName="Click" /> 
                        <asp:AsyncPostBackTrigger ControlID ="Acq_Delete_Bttn"  EventName="Click" />  
                        <asp:AsyncPostBackTrigger ControlID ="Acq_Cancel_Bttn"  EventName="Click"  />
                        <asp:AsyncPostBackTrigger ControlID ="Acq_SaveNew_Bttn"  EventName="Click" />  
