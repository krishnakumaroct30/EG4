<%@ Page  Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Orders.aspx.vb" Inherits="EG4.Orders" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     function Select(Select) {
        ...
        function valid1() {
         ...
         function valid3() {
             ...
             if (document.getElementById('<%=DDL_Orders2.ClientID%>').value == "") {
                 alert("Please enter \" Select Order No  from Drop-Down\" field.");
                 document.getElementById("MainContent_DDL_Orders2").focus();
                 return (false);
             }
        ...
        function GetCheckStatus1() {
            var srcControlId = event.srcElement.id;
            var targetControlId = event.srcElement.id.replace('cbd', 'txt_App_CopyRecd');
            if (document.getElementById(srcControlId).checked)
                document.getElementById(targetControlId).disabled = false;
            else
                document.getElementById(targetControlId).disabled = true;
        ...
        function Select4(Select4) {

            var grdv = document.getElementById('<%= Grid1.ClientID %>');
            var chbk = "cbd";
            var txtbk = "txt_App_CopyRecd";

            var Inputs = grdv.getElementsByTagName("input");

            for (var n = 0; n < Inputs.length; ++n) {
                if (Inputs[n].type == 'checkbox' && Inputs[n].id.indexOf(chbk, 0) >= 0) {
                    Inputs[n].checked = Select4;
                }
                if (Inputs[n].type == 'text' && Inputs[n].id.indexOf(txtbk, 0) >= 0) {
                    if (Select4 == true) {
                        Inputs[n].disabled = false;
    ...
    </script><table id="ADMT1" runat="server" cellspacing="2" border="1"  cellpadding="1" class="style35">
            <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always" >
            ...
            <asp:Menu
                ...
                <Items>
                    ...
                    <asp:MenuItem ImageUrl="~/Images/ReceiveOver.png" Text="" Value="2"></asp:MenuItem>
                </Items>
   ...
   <asp:View ID="Tab1" runat="server">
        <table id="Table1" runat="server" cellspacing="2" border="1"  cellpadding="2" class="style35">
             ...
             <tr>
                <td class="style56" colspan="5" bgcolor="#336699">
                   <asp:Label ID="Label16" runat="server" Font-Size="Small" ForeColor="White" 
                        Font-Bold="True">Select Record(s) For Adding Order No.</asp:Label>
                </td>
            </tr>
             <tr>
                <td class="style56" colspan="5" bgcolor="#336699">
         ...
         <asp:GridView ID="Grid3" runat="server" AllowPaging="True" DataKeyNames="ACQ_ID"    
                     ...
                     <asp:BoundField   DataField="VOL_NO" SortExpression="VOL_NO" HeaderText="Vol" 
                    ...
                    <asp:TemplateField  HeaderText="Copy Ordered">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_App_CopyOrd" runat="server" Enabled="false" Font-Bold="true" ForeColor="Red" MaxLength="4" onkeypress="return isNumberKey(event)" Text='<%#  Eval("COPY_ORDERED") %>' visible="true" Width="45px">
                            </asp:TextBox>
                        </ItemTemplate>
                        <HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" /><ItemStyle ForeColor="#336699" BackColor="Red" Font-Bold="True" Font-Names="Tahoma" Font-Size="Small" Width="150px" />
                    </asp:TemplateField>
            ...
            <tr style=" color:Green; font-weight:bold">
                ...
                <td class="style55" colspan="2">
                    <asp:Button ID="Ord_Process_Bttn" runat="server" CssClass="styleBttn" 
                        ...
                        Width="74px" ToolTip="Press to Process the Approval" AccessKey="p" 
              ...
              <tr style=" font-weight:bold">
                <td class="style53"> 
                    Select Vendor *</td>
                <td class="style54" colspan="2">
                    <asp:DropDownList ID="DDL_Vendors" runat="server" AutoPostBack="True" 
                        Font-Bold="True" ForeColor="#0066CC" Width="98%">
                    </asp:DropDownList>
                ...
                <td class="style54" colspan="2">
                    <asp:Button ID="Ord_UnProcess_Bttn" runat="server" AccessKey="u" 
                        ...
                        Text="Un-Order" ToolTip="Press to Un-Order the Records" Width="74px" />
                  </td>               
            </tr>       
                 ...
                 <asp:GridView ID="Grid2" runat="server" AllowPaging="True" allowsorting="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TITLE" HeaderText="Title" SortExpression="TITLE" visible="true"><HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" Width="350px" /><ItemStyle Font-Names="Arial" forecolor="#0066FF" horizontalalign="Left" width="350px" /></asp:BoundField>
                             ...
                             <asp:BoundField DataField="VOL_NO" HeaderText="Vol No" SortExpression="VOL_NO" visible="true"><HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" Width="100px" /><ItemStyle Font-Names="Arial" forecolor="#0066FF" horizontalalign="Left" width="100px" /></asp:BoundField>
    ...
    <asp:View ID="Tab3" runat="server">
        <table id="Table3" runat="server" cellspacing="2" border="1"  cellpadding="2" class="style35">
            <tr>
                <td class="style56" colspan="5" bgcolor="#336699">
                   <asp:Label ID="Label4" runat="server" Font-Size="Small" ForeColor="White" 
                        Font-Bold="True" style="font-size: medium">Receive Documents</asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style56" colspan="5" bgcolor="#336699">
                   <asp:Label ID="Label8" runat="server" Font-Size="Small" ForeColor="White" Font-Bold="True">Select Order No from Drop-Down and Process it</asp:Label>
            ...
            <tr style=" color:Green; font-weight:bold">
                ...
                <td class="style55">
                    <asp:DropDownList ID="DDL_Orders2" runat="server" AutoPostBack="True" Font-Bold="True" ForeColor="#0066CC" Width="78%">
                    </asp:DropDownList>
                    <ajaxToolkit:ListSearchExtender ID="ListSearchExtender1" runat="server" Enabled="True" IsSorted="True" PromptCssClass="PromptCSS" TargetControlID="DDL_Orders2"></ajaxToolkit:ListSearchExtender>
                 </td>
                <td class="style55">
                    <asp:Label ID="Label14" runat="server" Text="Label" Font-Bold="True"  Font-Size="Small"></asp:Label>
                </td> 
                <td class="style55" colspan="2">
                    <asp:Button ID="Acq_Recv_Bttn" runat="server" CssClass="styleBttn" 
                        Font-Bold="True" ForeColor="Red" TabIndex="14" Text="Receive/Un-Receive " 
                        Width="200px" ToolTip="Press to Process the Approval" AccessKey="p" 
                        OnClientClick="return valid3();" Visible="False" />
                 </td>
              ...
              <tr style=" color:Green; font-weight:bold">
                <td class="style53"> 
                    Vendor</td>
                <td class="style54" colspan="2">
                    <asp:Label ID="Label13" runat="server" Text="Label" Font-Bold="True"  Font-Size="Small"></asp:Label></td>               
                <td class="style54" colspan="2">
                    &nbsp;</td>               
            </tr>       
             ...
             <tr>
                <td class="style56" colspan="5" bgcolor="#336699">
                   <asp:Label ID="Label12" runat="server" Font-Size="Small" ForeColor="White" 
                        Font-Bold="True">HELP: Selected Record(s) will be Received / Not Selected Record(s) will be Un-Received!</asp:Label>
                </td>
            </tr>
                 ...
                 <asp:GridView ID="Grid1" runat="server" AllowPaging="True" allowsorting="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="COPY_ORDERED" HeaderText="Copy Ordered" visible="true"><HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" Width="180px" /><ItemStyle Font-Names="Arial" forecolor="#0066FF" horizontalalign="Left" width="180px" /></asp:BoundField>
                             ...
                             <asp:TemplateField  HeaderText="Copy Recd"><ItemTemplate><asp:TextBox ID="txt_App_CopyRecd" runat="server" Enabled="false" Font-Bold="true" ForeColor="Red" MaxLength="4" onkeypress="return isNumberKey(event)"  Text='<%#  Eval("COPY_RECEIVED") %>' visible="true" Width="45px"></asp:TextBox></ItemTemplate><HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" /><ItemStyle ForeColor="#336699" BackColor="Red" Font-Bold="True" Font-Names="Tahoma" Font-Size="Small"  Width="150px" /></asp:TemplateField>
                    
                    
                    <asp:TemplateField  ControlStyle-Width="10px"  HeaderText="Select Record(s) to Receive" FooterText="Select" ShowHeader="true"><ItemTemplate><asp:CheckBox ID="cbd"  runat="server" onclick="GetCheckStatus1()" /></ItemTemplate><FooterStyle  ForeColor="White" /><HeaderTemplate><asp:ImageButton ID="ImageButton5" runat="server" Height="16px" Width="16px" ToolTip="Select All" ImageUrl="~/Images/check_all.gif" onClientclick="return Select4(true)"  /><asp:ImageButton ID="ImageButton6" runat="server" Height="16px" Width="16px" ToolTip="Deselect All" ImageUrl="~/Images/uncheck_all.gif"  onClientClick ="return Select4(false)" /></HeaderTemplate><ControlStyle Width="50px"></ControlStyle></asp:TemplateField>
                        </Columns>
                        <PagerStyle BackColor="#3399FF" BorderColor="#C0C000" BorderStyle="Solid" Font-Bold="True" Font-Size="Small" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
                        <RowStyle BackColor="#DADADA" BorderColor="Desktop" ForeColor="#3399FF" />
                        <SelectedRowStyle BackColor="Desktop" BorderColor="SteelBlue" BorderStyle="Solid" />
