<%@ Page  Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="JApprovals.aspx.vb" Inherits="EG4.JApprovals" %>
    ...
    <script language ="javascript" type ="text/javascript" >
     ...
     <script language="javascript" type="text/javascript">
         ...
         function valid1() {
             ...
             if (document.getElementById('<%=txt_Acq_SubsYear.ClientID%>').value == "") {
                 alert("Please enter \" Subscription Year in YYYY Format\" field.");
                 document.getElementById("MainContent_txt_Acq_SubsYear").focus();
                 return (false);
             }
   ...
   <asp:View ID="Tab1" runat="server">
        <table id="Table1" runat="server" cellspacing="2" border="1"  cellpadding="2" class="style35">
            ...
            <tr>
                ...
                <td class="style55">
                    <asp:TextBox ID="txt_Acq_AppNo" runat="server" AutoCompleteType="DisplayName" 
                        ...
                        ToolTip="Enter Distinct Approval/List No " Width="90%" Wrap="False" 
                ...
                <td class="style55">
                    Approval Date:</td>
                <td class="style55">
                    Subs. Year*:<asp:TextBox ID="txt_Acq_SubsYear" runat="server" 
                        AutoCompleteType="DisplayName" Font-Bold="True" ForeColor="#0066FF" 
                        Height="18px" MaxLength="4" 
                        ToolTip="Enter Subscription Year in YYYY Format" Width="40px" 
                        Wrap="False" onkeypress="return isNumberKey(event)"></asp:TextBox>
                </td>                
                <td class="style55">
                    Copy*:<asp:TextBox ID="txt_Acq_Copy" runat="server" 
                        AutoCompleteType="DisplayName" Font-Bold="True" ForeColor="#0066FF" 
                        Height="18px" MaxLength="4" 
                        ToolTip="Enter No of Copies Proposed (Numeric Only)" Width="30px" 
                        Wrap="False" onkeypress="return isNumberKey(event)"></asp:TextBox>
                </td>                
            </tr>
            <tr>
                ...
                <td class="style55">
                    ...
                    <asp:Label ID="Label4" runat="server" Text="Label" Font-Size="X-Small"></asp:Label>
                </td>
                <td class="style55">
                    Item Cost *&nbsp;
                ...
                <td class="style55" colspan="2">
                    <asp:Label ID="Label8" runat="server" Text="Acq. Mode:" 
             ...
             <tr>
                <td class="style47" colspan="5">
                    ...
                    <asp:Button ID="App_DeleteAll_Bttn" runat="server" AccessKey="d" 
                        CssClass="styleBttn" Font-Bold="True" ForeColor="Red" Height="23px" 
                        TabIndex="14" Text="Delete Selected Approval Record(s)" ToolTip="Press to Cancel" 
                        Width="240px" />
                 </td>
            </tr>
         ...
         <asp:GridView ID="Grid1" runat="server" AllowPaging="True" DataKeyNames="ACQ_ID"    
                    ...
                    <asp:BoundField   DataField="SUBS_YEAR" HeaderText="Year" SortExpression="SUBS_YEAR" >                                               
                            <HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" />
                        <ItemStyle forecolor="#0066FF" horizontalalign="Left" width="150px" Font-Names="Arial"/>                        
                    </asp:BoundField>
        ...
        <table id="Table2" runat="server" cellspacing="2" border="1"  cellpadding="2" class="style35">
            ...
            <tr style=" color:Green; font-weight:bold">
              ...
              <tr style=" color:Green; font-weight:bold">
                ...
                <td class="style54" colspan="2">
                    Com. Email :<asp:TextBox ID="txt_App_CommiteeEmail" runat="server" 
                        Font-Bold="True" ForeColor="#0066FF" Height="16px" MaxLength="100" 
                        ToolTip="Enter Committee Email" Width="150px"></asp:TextBox>
         ...
         <asp:GridView ID="Grid2" runat="server" AllowPaging="True" DataKeyNames="ACQ_ID"    
                        style="width: 100%;  text-align: center; color: #CC3300;" allowsorting="True" 
                        AutoGenerateColumns="False"  Font-Bold="True" 
                        Font-Names="Tahoma" Font-Size="8pt" Height="100px"  
                        HorizontalAlign="Center"   ShowFooter="True">
                        <Columns >                
                    ...
                    <asp:BoundField   DataField="APP_DATE" SortExpression="APP_DATE" HeaderText="Approval Date" visible="true"  DataFormatString="{0:dd/MM/yyyy}">                                               
                     ...
                     <asp:BoundField   DataField="SUBS_YEAR" SortExpression="SUBS_YEAR" HeaderText="Subs.Year" visible="true">                                               
                     ...
                     <asp:BoundField   DataField="PROCESS_STATUS" SortExpression="PROCESS_STATUS" HeaderText="Status" visible="true">                                               
                        ...
                        <ItemStyle forecolor="#CC3300" horizontalalign="Left" width="160px" 
                                Font-Names="Arial"/>                        
                    </asp:BoundField>
             ...
             <tr>  
                <td class="style56" colspan="4" bgcolor="#336699">                
                  ...
                  <asp:GridView ID="Grid3" runat="server" AllowPaging="True" DataKeyNames="ACQ_ID"  
                    ...
                    <asp:BoundField   DataField="SUBS_YEAR" HeaderText="Subs.Year" ReadOnly="True"  SortExpression="SUBS_YEAR">                                               
                            <HeaderStyle Font-Bold="True" Font-Names="Arial" Font-Size="Small" />
